// lib/ollamaService.js

export async function auditarTextoConOllama(textoDocumento) {
    try {
        const promptSistema = `
...
Tu propósito es ayudar a un Auditor independiente a evaluar la documentación de proveedores industriales y contratistas de la gran minería (Antofagasta, La Negra, Mejillones) para blindarlos ante bancos (financiamiento verde) y mandantes mineros (cumplimiento SICEP y The Copper Mark).
...
- Sugiere redacciones o modificaciones contractuales para mitigar los riesgos detectados.
        ...
        throw new Error('No se pudo procesar la auditoría con IA. Verifica que Ollama esté ejecutándose localmente (ollama serve) y que el modelo llama3 esté descargado (ollama pull llama3).');
    }
}
